...
parser.add_argument("-n", "--number", help="number of optimized structures to compare. If float, will take top percent of values, if integer, will use that many best values, use 0 to take all optimized structures", default=1, type=float)
